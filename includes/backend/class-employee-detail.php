...
class WC_Team_Payroll_Employee_Detail {
	...
	public function render_employee_detail() {
		...
		?>
		<div class="wrap wc-team-payroll-employee-detail" data-user-id="<?php echo intval( $user_id ); ?>" data-currency-symbol="<?php echo esc_attr( $wc_currency_symbol ); ?>" data-currency-pos="<?php echo esc_attr( $wc_currency_pos ); ?>">
			<!-- Back Button -->
			<div class="wc-tp-back-button">
