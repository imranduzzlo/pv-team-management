...
class WC_Team_Payroll_Page {
	...
	public function enqueue_assets() {
		...
		// Enqueue common CSS
		wp_enqueue_style( 'wc-tp-common', plugin_dir_url( __FILE__ ) . '../../assets/css/common.css', array(), '5.5.3' );

		// Enqueue payroll-specific CSS
		wp_enqueue_style( 'wc-tp-payroll', plugin_dir_url( __FILE__ ) . '../../assets/css/payroll.css', array( 'wc-tp-common' ), '5.5.3' );

		// Enqueue common JS
		wp_enqueue_script( 'wc-tp-common', plugin_dir_url( __FILE__ ) . '../../assets/js/common.js', array( 'jquery' ), '5.5.3', true );

		// Enqueue payroll-specific JS
		wp_enqueue_script( 'wc-tp-payroll', plugin_dir_url( __FILE__ ) . '../../assets/js/payroll.js', array( 'jquery', 'wc-tp-common' ), '5.5.3', true );
	}
