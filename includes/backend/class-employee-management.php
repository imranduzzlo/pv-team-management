...
class WC_Team_Payroll_Employee_Management {
	...
	public function enqueue_assets() {
		...
		// Enqueue common CSS
		wp_enqueue_style( 'wc-tp-common', plugin_dir_url( __FILE__ ) . '../../assets/css/common.css', array(), '5.6.0' );

		// Enqueue employees-specific CSS
		wp_enqueue_style( 'wc-tp-employees', plugin_dir_url( __FILE__ ) . '../../assets/css/employees.css', array( 'wc-tp-common' ), '5.6.0' );

		// Enqueue common JS
		wp_enqueue_script( 'wc-tp-common', plugin_dir_url( __FILE__ ) . '../../assets/js/common.js', array( 'jquery' ), '5.6.0', true );

		// Enqueue employees-specific JS
		wp_enqueue_script( 'wc-tp-employees', plugin_dir_url( __FILE__ ) . '../../assets/js/employees.js', array( 'jquery', 'wc-tp-common' ), '5.6.0', true );
	}
