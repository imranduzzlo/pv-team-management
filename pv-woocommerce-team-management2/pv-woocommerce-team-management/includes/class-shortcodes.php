...
class WC_Team_Payroll_Shortcodes {
	...
	public function __construct() {
		add_shortcode( 'team_earnings', array( $this, 'shortcode_earnings' ) );
		add_shortcode( 'team_orders', array( $this, 'shortcode_orders' ) );
		add_action( 'admin_menu', array( $this, 'add_shortcode_builder' ) );
	}

	public function add_shortcode_builder() {
		add_submenu_page(
			'woocommerce',
	...
	public function shortcode_earnings( $atts ) {
